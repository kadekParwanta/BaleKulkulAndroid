...
public class FileList extends ListActivity implements ResultProvider {
	...
	public final void onCreate(final Bundle savedInstanceState) {
		...
		setContentView(R.layout.dict_directory_list);
	...
	private void fill(final File parentDirectory) {
		...
		if (findViewById(R.id.PathView).getVisibility() == View.GONE) {
			fileList = new ArrayAdapter<String>(this, R.layout.dict_file_row, items);
		} else {
			fileList = new ArrayAdapter<String>(this, R.layout.dict_file_row, itemsFileName);
		}
