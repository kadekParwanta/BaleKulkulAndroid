...
import com.herokuapp.balekulkulandroid.dictionary.general.CouldNotOpenFileException;
...
public class NativeZipInputStreamAccess extends DfMInputStreamAccess {
	...
	/**
	 * Gets the {@link java.io.InputStream} of the specified file in the current
	 * zip-file.
	 * 
	 * @param fileName
	 *            the name of the included file
	 * @return the {@link java.io.InputStream} or null
	 * @throws DictionaryException
	 *             if an input error occurred
	 */
