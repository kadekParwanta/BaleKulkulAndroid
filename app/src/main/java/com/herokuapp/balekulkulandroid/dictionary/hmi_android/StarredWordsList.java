...
import com.herokuapp.balekulkulandroid.dictionary.hmi_android.data.StarredWordsAdapter;
import com.herokuapp.balekulkulandroid.dictionary.hmi_android.data.StarredWordsProvider;
import com.herokuapp.balekulkulandroid.dictionary.hmi_android.data.StarredWordsProvider.StarredWords;
...
//			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dict_starred_words_list);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.dict_starred_words_options, menu);
		return true;
	}
