...
import com.herokuapp.balekulkulandroid.dictionary.dataaccess.LanguageDefinition;
...
import com.herokuapp.balekulkulandroid.dictionary.hmi_android.view_helper.SingleTranslationViewHelper;
import com.herokuapp.balekulkulandroid.dictionary.translation.SingleTranslation;
...
//		SingleTranslationViewHelper.display(result, translation);
	...
	public View getChildView(int i, int i2, boolean b, View view, final ViewGroup viewGroup) {
		...
		if (view == null) {
			final LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
			result = inflater.inflate(R.layout.dict_translation_row, null);
