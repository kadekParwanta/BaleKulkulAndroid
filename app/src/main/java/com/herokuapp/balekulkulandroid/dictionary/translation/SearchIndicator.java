...
public class SearchIndicator {
	...
	public SearchIndicator(char searchIndicatorCharacter) throws DictionaryException  {
		if (searchIndicatorCharacter == beginOfExpressionChar)
			beginOfExpression = true;
		else if (searchIndicatorCharacter == substringOfExpressionChar)
			beginOfExpression = false;
		else
	...
	public char asChar() {
		if (beginOfExpression)
			return beginOfExpressionChar;
		else
			return substringOfExpressionChar;
	}
}
