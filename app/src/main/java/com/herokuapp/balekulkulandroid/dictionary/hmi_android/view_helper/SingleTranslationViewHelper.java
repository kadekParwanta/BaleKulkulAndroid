...
import com.herokuapp.balekulkulandroid.dictionary.dataaccess.content.FontStyle;
import com.herokuapp.balekulkulandroid.dictionary.dataaccess.content.RGBColour;
import com.herokuapp.balekulkulandroid.dictionary.general.DictionaryException;
import com.herokuapp.balekulkulandroid.dictionary.hmi_android.DictionaryForMIDs;
...
import com.herokuapp.balekulkulandroid.dictionary.hmi_common.content.StringColourItemText;
import com.herokuapp.balekulkulandroid.dictionary.hmi_common.content.StringColourItemTextPart;
		...
		try {
			for (StringColourItemText text : result.getToTextsAsColourItemTexts()) {
				...
				final TextView toLanguageText = (TextView) inflater.inflate(
						R.layout.dict_translation_part, null);
			...
			final LayoutInflater inflater = LayoutInflater.from(toLanguagesRows.getContext());
			final TextView toLanguageText = (TextView) inflater.inflate(R.layout.dict_translation_part,
					null);
